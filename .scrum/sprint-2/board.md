...
- [ ] S2-001: SwiftData モデル定義（TripRecord / RoutePoint / PinRecord） → dev-1
- [ ] S2-002: ModelContainer セットアップとアプリ統合 → dev-1
- [ ] S2-003: TripRepository（取得・作成・更新・距離加算） → dev-1
- [ ] S2-004: 総移動距離計算ロジック（CLLocation.distance ベース） → dev-2
